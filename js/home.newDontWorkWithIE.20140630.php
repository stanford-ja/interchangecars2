...
// Start tool-tips
$(function() {
	$('#search_expand').tipsy({gravity: 'n',fade: true}); // nw | n | ne | w | e | sw | s | se
	$('#tr_expand').tipsy({gravity: 'n',fade: true});
	$('#rr_expand').tipsy({gravity: 'n',fade: true});
	$('#po_expand').tipsy({gravity: 'n',fade: true});
	$('#me_expand').tipsy({gravity: 'n',fade: true});
});
// End tool-tips
</script>
