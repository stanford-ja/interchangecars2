...
?>
	...
	function selRoute(){
		$(document).ready(function(){
			...
			//tds.style.display = 'none';
			//tds.value = '&nbsp;';
			var p = "<?php echo JS_ROOT; ?>/ajax.php?f=selRoute&d=" + trd + "&s=" + tre + "&e=" + trx;
