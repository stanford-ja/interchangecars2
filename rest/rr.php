...
class rr {
	...
	function basicinfo(){
		...
		$this->details['list_fields'] = array("rr_name","report_mark","owner_name","interchanges","affiliates");
		$this->details['list_headings'] = array("RR Name","Reporting Mark","Owner","Interchanges","Affiliates");
		$this->details['id_key'] = "id";
		$this->details['title'] = "Railroads";
		if($this->id > 0){$this->details['title'] = "Railroad info: ".$this->id;}
	}
