	...
	<div id="mainMenu"> <!-- START OF mainMenu MENU DIV // -->
			...
			<div style="display: table-row;">
				...
				<div style="display: table-cell; padding: 10px; font-size: 13pt;" class="td_menu_title">
					<div style="display: block; max-height: 140px; overflow: auto;">

						<div class="td_menu" style="display: inline-block;"><span data-balloon="Go to Home page" data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/home", "Home"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Create a new waybill / purchase order." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/".$wb_lnk, "New WB"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Customer P/Ordes List." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/".$rwb_lnk, "Customer POs"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Manage your Cars Pool." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/".$ca_lnk, "Cars Pool"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Manage your Motive Power." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/".$mv_lnk, "Motive Power"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Manage AAR Car Types Codes." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/aar", "AAR Codes"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Manage your Industries." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/".$in_lnk, "Industries"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Manage Commodities." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/commod", "Commodities"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Manage your Trains." data-balloon-pos="left" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/".$tr_lnk, "Trains"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Manage Locations." data-balloon-pos="left" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/locations", "Locations"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Industry, Motive Power, Car Pool and Train allocations for your Affiliates." data-balloon-pos="left" data-balloon-length="xlarge"><?php echo anchor(WEB_ROOT."/affiliates/mv", "Affiliates"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="About the MRICF." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/about", "About"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="North America Map." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/index.php/map/usa", "Map"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Help and Information Pages." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/pages", "Pages"); ?></span></div>
						...
						<div class="td_menu" style="display: inline-block;"><span data-balloon="Upload a CSV file to update your railroads data." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/dat/csv_file", "Upload"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="View Waybill Images." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/graphics/viewall", "WB Images"); ?></span></div>
						<div class="td_menu" style="display: inline-block;"><span data-balloon="View Railroads List." data-balloon-pos="right" data-balloon-length="large"><?php echo anchor(WEB_ROOT."/rr", "Railroads"); ?></span></div>
