			...
			<div style="display: table-row;">
				...
				<div style="display: table-cell; padding: 10px; font-size: 13pt;" class="td_menu_title">
					<div style="display: block; max-height: 120px; overflow: auto;">
						...
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/home", "Home"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/".$wb_lnk, "New WB"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/".$rwb_lnk, "Customer POs"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/".$ca_lnk, "Cars Pool"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/".$mv_lnk, "Motive Power"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/aar", "AAR Codes"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/".$in_lnk, "Industries"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/commod", "Commodities"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/".$tr_lnk, "Trains"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/locations", "Locations"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/affiliates/mv", "Affiliates"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/about", "About"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/index.php/map/usa", "Map"); ?></div>
						<div class="td_menu" style="display: inline-block;"><?php echo anchor(WEB_ROOT."/pages", "Pages"); ?></div>
