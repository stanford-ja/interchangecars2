...
?>
	...
	<input type="hidden" name="chkd" id="chkd" value="" />
		<table border="0" width="100%" align="center" style="background-color: transparent; border: none;">						
			...
			<?php if(isset($auto_ent) && count($auto_ent) > 0){ ?>
...
// -->
		<div style="display: block; vertical-align: top;">
			...
			<div class="wbElement">
				...
				<input type="text" id="fld11" name="fld11" value="<?php echo $fld11; ?>" onKeyUp="autoComp(this.value,'ichange_commod','commod_name','fld11');" style="width: 310px;" />
				</span>
				</div>
				</div>
				<?php if($fld11 == "MT" || $fld11 == "MTY"){ ?>
				...
				<span data-balloon="Where to return the car/s on this waybill to when they have been unloaded." data-balloon-pos="right" data-balloon-length="large">
					<input type="text" id="fld19" name="fld19" maxsize="40" value="<?php echo $fld19; ?>" style="width: 310px;" />
				</span>
				</div>
			...
			<?php if(count($rr_ics) > 0){ ?>
				...
				for($ric=0;$ric<count($rr_ics_k);$ric++){
					...
					$icl .= "<div style=\"display: inline-block; height: 75px; border: 1px solid maroon; border-radius: 3px; padding: 3px; margin: 2px; background-color: transparent; font-size: 9pt; vertical-align: top; background-color: #ddd;\"><div style=\"height: 70px; overflow: auto;\"><strong>".$rr_ics_k[$ric]."</strong><br />".$rr_ics[$rr_ics_k[$ric]]['ics']."</div></div>";
				} 
				echo $icl;
				?>
				</div>
