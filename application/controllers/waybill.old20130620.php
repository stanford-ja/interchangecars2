...
class Waybill extends CI_Controller {
	...
	public function edit($id=0){
		...
		// List of cars for RR
		$cars_opts = (array)$this->Cars_model->getCars4RR($this->arr['rr_sess'],array('aar_type','car_num'));
	...
	function transhipped_wbs($fld8){
		...
		$ts1 = "SELECT `waybill_num`,`id` FROM `ichange_waybill` WHERE `waybill_num` LIKE '".$fld8."%' AND `waybill_num` != '".$fld8."'";
