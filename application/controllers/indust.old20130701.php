...
class Indust extends CI_Controller {
	...
	public function lst(){
		...
		//$this->dat = array();
		$this->dat['fields'] 			= array('id', 'indust_name', 'desc', 'rr', 'freight_in', 'freight_out','modified');
		$this->dat['field_names'] 		= array("ID", "Name", "Desc", "RR", "Freight In", "Freight Out","Added/Modified");
