...
class Switchlist extends CI_Controller {
	...
	public function lst($id=0,$printit=0){
		$this->arr['id'] = $id;
		if($printit == 0){
		...
		$this->trdat['data'][0]['train_id'] = "<span style=\"float: right;\" class=\"dontprint\">
			...
			<a href=\"javascript:{}\" class=\"searchLink\" onclick=\"window.open('".WEB_ROOT.INDEX_PAGE."/switchlist/printit/".$id."');\">-- PRINT --</a>
			</span>".
		...
		*/
		...
		if($printit == 0){ $this->load->view('footer'); }
	}
